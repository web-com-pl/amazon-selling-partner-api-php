...
class DebtRecoveryItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'group_begin_date' => '\Webcom\Amazon\Rest\FinancesApi\Model\\DateTime',
        'group_end_date' => '\Webcom\Amazon\Rest\FinancesApi\Model\\DateTime'
    ];
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\Currency $recovery_amount The amount applied for the recovery item.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\Currency $original_amount The original debt amount.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\\DateTime $group_begin_date The beginning date and time of the financial event group that contains the debt. In ISO 8601 date time format.
     *
     * @return $this
     */
     ...
     * Sets group_end_date
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\\DateTime $group_end_date The ending date and time of the financial event group that contains the debt. In ISO 8601 date time format.
     *
     * @return $this
     */
