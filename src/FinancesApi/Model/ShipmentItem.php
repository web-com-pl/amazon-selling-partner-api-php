...
class ShipmentItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'item_charge_list' => '\Webcom\Amazon\Rest\FinancesApi\Model\ChargeComponentList',
        'item_charge_adjustment_list' => '\Webcom\Amazon\Rest\FinancesApi\Model\ChargeComponentList',
        'item_fee_list' => '\Webcom\Amazon\Rest\FinancesApi\Model\FeeComponentList',
        'item_fee_adjustment_list' => '\Webcom\Amazon\Rest\FinancesApi\Model\FeeComponentList',
        'item_tax_withheld_list' => '\Webcom\Amazon\Rest\FinancesApi\Model\TaxWithheldComponentList',
        'promotion_list' => '\Webcom\Amazon\Rest\FinancesApi\Model\PromotionList',
        'promotion_adjustment_list' => '\Webcom\Amazon\Rest\FinancesApi\Model\PromotionList',
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\ChargeComponentList $item_charge_list A list of charges associated with the shipment item.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\ChargeComponentList $item_charge_adjustment_list A list of charge adjustments associated with the shipment item. This value is only returned for refunds, guarantee claims, and chargeback events.
     *
     * @return $this
     */
     ...
     * Sets item_fee_list
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\FeeComponentList $item_fee_list A list of fees associated with the shipment item.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\FeeComponentList $item_fee_adjustment_list A list of fee adjustments associated with the shipment item. This value is only returned for refunds, guarantee claims, and chargeback events.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\FinancesApi\Model\TaxWithheldComponentList
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\TaxWithheldComponentList $item_tax_withheld_list A list of taxes withheld information for a shipment item.
     *
     * @return $this
     */
     ...
     * Gets promotion_list
     *
     * @return \Webcom\Amazon\Rest\FinancesApi\Model\PromotionList
     */
     ...
     * Sets promotion_list
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\PromotionList $promotion_list promotion_list
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\PromotionList $promotion_adjustment_list A list of promotion adjustments associated with the shipment item. This value is only returned for refunds, guarantee claims, and chargeback events.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\Currency $cost_of_points_granted The cost of Amazon Points granted for a shipment item.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\Currency $cost_of_points_returned The cost of Amazon Points returned for a shipment item. This value is only returned for refunds, guarantee claims, and chargeback events.
     *
     * @return $this
     */
