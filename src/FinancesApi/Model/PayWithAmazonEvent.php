...
class PayWithAmazonEvent implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'transaction_posted_date' => '\Webcom\Amazon\Rest\FinancesApi\Model\\DateTime',
        'business_object_type' => 'string',
        'sales_channel' => 'string',
        'charge' => '\Webcom\Amazon\Rest\FinancesApi\Model\ChargeComponent',
        'fee_list' => '\Webcom\Amazon\Rest\FinancesApi\Model\FeeComponentList',
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\\DateTime $transaction_posted_date The date and time when the payment transaction is posted. In ISO 8601 date time format.
     *
     * @return $this
     */
     ...
     * Gets charge
     *
     * @return \Webcom\Amazon\Rest\FinancesApi\Model\ChargeComponent
     */
     ...
     * Sets charge
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\ChargeComponent $charge The charge associated with the event.
     *
     * @return $this
     */
     ...
     * Sets fee_list
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\FeeComponentList $fee_list A list of fees associated with the event.
     *
     * @return $this
     */
