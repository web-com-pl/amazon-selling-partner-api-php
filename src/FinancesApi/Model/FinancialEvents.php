...
class FinancialEvents implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'trialShipmentEventList'                 => '\Webcom\Amazon\Rest\FinancesApi\Model\TrialShipmentEvent[]',
        'shipmentSettleEventList'                => '\Webcom\Amazon\Rest\FinancesApi\Model\ShipmentEvent[]',
        'taxWithholdingEventList'                => '\Webcom\Amazon\Rest\FinancesApi\Model\TaxWithholdingEvent[]',
        'removalShipmentEventList'               => '\Webcom\Amazon\Rest\FinancesApi\Model\RemovalShipmentEvent[]',
        'removalShipmentAdjustmentEventList'     => '\Webcom\Amazon\Rest\FinancesApi\Model\RemovalShipmentAdjustmentEvent[]'
    ];
     ...
     *
     * @return \Webcom\Amazon\Rest\FinancesApi\Model\TrialShipmentEvent[]|null
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\TrialShipmentEvent[]|null $trialShipmentEventList A list of information about trial shipment financial events.
     *
     * @return self
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\ShipmentEvent[]|null $shipmentSettleEventList A list of information about shipment settle financial events.
     *
     * @return self
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\FinancesApi\Model\TaxWithholdingEvent[]|null
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\TaxWithholdingEvent[]|null $taxWithholdingEventList List of TaxWithholding events.
     *
     * @return self
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\FinancesApi\Model\RemovalShipmentEvent[]|null
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\RemovalShipmentEvent[]|null $removalShipmentEventList A list of removal shipment event information.
     *
     * @return self
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\FinancesApi\Model\RemovalShipmentAdjustmentEvent[]|null
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\RemovalShipmentAdjustmentEvent[]|null $removalShipmentAdjustmentEventList A comma-delimited list of Removal shipmentAdjustment details for FBA inventory.
     *
     * @return self
     */
