...
class ChargeInstrument implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'description' => 'string',
        'tail' => 'string',
        'amount' => '\Webcom\Amazon\Rest\FinancesApi\Model\Currency'
    ];
     ...
     * Sets amount
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\Currency $amount The amount charged to this charge instrument.
     *
     * @return $this
     */
