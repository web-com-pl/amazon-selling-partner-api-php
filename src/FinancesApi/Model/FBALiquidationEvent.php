...
class FBALiquidationEvent implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\Currency $liquidation_proceeds_amount The amount paid by the liquidator for the seller's inventory. The seller receives this amount minus LiquidationFeeAmount.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\Currency $liquidation_fee_amount The fee charged to the seller by Amazon for liquidating the seller's FBA inventory.
     *
     * @return $this
     */
