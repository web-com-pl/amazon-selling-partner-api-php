...
class ShipmentEvent implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'order_charge_list' => '\Webcom\Amazon\Rest\FinancesApi\Model\ChargeComponentList',
        'order_charge_adjustment_list' => '\Webcom\Amazon\Rest\FinancesApi\Model\ChargeComponentList',
        'shipment_fee_list' => '\Webcom\Amazon\Rest\FinancesApi\Model\FeeComponentList',
        'shipment_fee_adjustment_list' => '\Webcom\Amazon\Rest\FinancesApi\Model\FeeComponentList',
        'order_fee_list' => '\Webcom\Amazon\Rest\FinancesApi\Model\FeeComponentList',
        'order_fee_adjustment_list' => '\Webcom\Amazon\Rest\FinancesApi\Model\FeeComponentList',
        'direct_payment_list' => '\Webcom\Amazon\Rest\FinancesApi\Model\DirectPaymentList',
        'posted_date' => '\Webcom\Amazon\Rest\FinancesApi\Model\\DateTime',
        'shipment_item_list' => '\Webcom\Amazon\Rest\FinancesApi\Model\ShipmentItemList',
        'shipment_item_adjustment_list' => '\Webcom\Amazon\Rest\FinancesApi\Model\ShipmentItemList'
    ];
     ...
     *
     * @return \Webcom\Amazon\Rest\FinancesApi\Model\ChargeComponentList
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\ChargeComponentList $order_charge_list A list of order-level charges. These charges are applicable to Multi-Channel Fulfillment COD orders.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\ChargeComponentList $order_charge_adjustment_list A list of order-level charge adjustments. These adjustments are applicable to Multi-Channel Fulfillment COD orders.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\FinancesApi\Model\FeeComponentList
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\FeeComponentList $shipment_fee_list A list of shipment-level fees.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\FeeComponentList $shipment_fee_adjustment_list A list of shipment-level fee adjustments.
     *
     * @return $this
     */
     ...
     * Sets order_fee_list
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\FeeComponentList $order_fee_list A list of order-level fees. These charges are applicable to Multi-Channel Fulfillment orders.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\FeeComponentList $order_fee_adjustment_list A list of order-level fee adjustments. These adjustments are applicable to Multi-Channel Fulfillment orders.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\FinancesApi\Model\DirectPaymentList
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\DirectPaymentList $direct_payment_list A list of transactions where buyers pay Amazon through one of the credit cards offered by Amazon or where buyers pay a seller directly through COD.
     *
     * @return $this
     */
     ...
     * Sets posted_date
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\\DateTime $posted_date The date and time when the financial event was posted.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\FinancesApi\Model\ShipmentItemList
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\ShipmentItemList $shipment_item_list shipment_item_list
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\ShipmentItemList $shipment_item_adjustment_list A list of shipment item adjustments.
     *
     * @return $this
     */
