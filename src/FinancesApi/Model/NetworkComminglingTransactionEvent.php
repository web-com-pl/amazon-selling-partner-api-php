...
class NetworkComminglingTransactionEvent implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\Currency $tax_exclusive_amount The price of the swapped item minus TaxAmount.
     *
     * @return $this
     */
     ...
     * Sets tax_amount
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\Currency $tax_amount The tax on the network item swap paid by the seller.
     *
     * @return $this
     */
