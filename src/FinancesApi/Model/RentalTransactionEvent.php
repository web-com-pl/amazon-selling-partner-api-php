...
class RentalTransactionEvent implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'rental_charge_list' => '\Webcom\Amazon\Rest\FinancesApi\Model\ChargeComponentList',
        'rental_fee_list' => '\Webcom\Amazon\Rest\FinancesApi\Model\FeeComponentList',
        ...
        'rental_tax_withheld_list' => '\Webcom\Amazon\Rest\FinancesApi\Model\TaxWithheldComponentList'
    ];
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\ChargeComponentList $rental_charge_list A list of charges associated with the rental event.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\FeeComponentList $rental_fee_list A list of fees associated with the rental event.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\Currency $rental_initial_value The amount of money the customer originally paid to rent the item. This value is only returned for RentalChargeFailureReimbursement and RentalLostItemReimbursement events.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\Currency $rental_reimbursement The amount of money Amazon sends the seller to compensate for a lost item or a failed charge. This value is only returned for RentalChargeFailureReimbursement and RentalLostItemReimbursement events.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FinancesApi\Model\TaxWithheldComponentList $rental_tax_withheld_list A list of taxes withheld information for a rental item.
     *
     * @return $this
     */
