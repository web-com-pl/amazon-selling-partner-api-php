...
class ConfirmPreorderResult implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'confirmed_fulfillable_date' => '\Webcom\Amazon\Rest\FulfillmentInboundApi\Model\DateStringType'
    ];
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApi\Model\DateStringType $confirmed_need_by_date Date passed in with the NeedByDate parameter. The confirmed shipment must arrive at the Amazon fulfillment center by this date to avoid delivery promise breaks for pre-ordered items. In YYYY-MM-DD format.
     *
     * @return $this
     */
