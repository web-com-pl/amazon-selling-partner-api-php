...
class GetPreorderInfoResult implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'need_by_date' => '\Webcom\Amazon\Rest\FulfillmentInboundApi\Model\DateStringType',
     ...
     * Sets need_by_date
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApi\Model\DateStringType $need_by_date Date that the shipment would need to arrive at an Amazon fulfillment center to avoid delivery promise breaks for pre-ordered items if this shipment is later confirmed for pre-order. In YYYY-MM-DD format. See also the confirmPreorder operation.
     *
     * @return $this
     */
