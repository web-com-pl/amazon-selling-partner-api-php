...
class PartneredLtlDataOutput implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'preview_pickup_date' => '\Webcom\Amazon\Rest\FulfillmentInboundApi\Model\DateStringType',
        'preview_delivery_date' => '\Webcom\Amazon\Rest\FulfillmentInboundApi\Model\DateStringType',
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApi\Model\DateStringType $freight_ready_date The date that the shipment will be ready to be picked up by the carrier. Must be in YYYY-MM-DD format.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApi\Model\Amount $seller_declared_value Your declaration of the total value of the inventory in the shipment.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApi\Model\Amount $amazon_calculated_value Estimate by Amazon of the total value of the inventory in the shipment.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApi\Model\DateStringType $preview_pickup_date The estimated date that the shipment will be picked up by the carrier, in YYYY-MM-DD format.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApi\Model\DateStringType $preview_delivery_date The estimated date that the shipment will be delivered to an Amazon fulfillment center, in YYYY-MM-DD format.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApi\Model\SellerFreightClass $preview_freight_class The freight class of the shipment as estimated by Amazon if you did not include a freight class when you called the putTransportDetails operation.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\FulfillmentInboundApi\Model\PartneredEstimate
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApi\Model\PartneredEstimate $partnered_estimate The estimated shipping cost using an Amazon-partnered carrier.
     *
     * @return $this
     */
