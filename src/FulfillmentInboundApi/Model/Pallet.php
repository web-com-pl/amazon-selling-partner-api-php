...
class Pallet implements ModelInterface, ArrayAccess
{
     ...
     * Sets dimensions
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApi\Model\Dimensions $dimensions The dimensions of the pallet. Length and width must be 40 inches by 48 inches. Height must be less than or equal to 60 inches.
     *
     * @return $this
     */
     ...
     * Sets weight
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApi\Model\Weight $weight The weight of the pallet.
     *
     * @return $this
     */
