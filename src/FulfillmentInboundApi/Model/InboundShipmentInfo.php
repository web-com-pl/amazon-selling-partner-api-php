...
class InboundShipmentInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'confirmed_need_by_date' => '\Webcom\Amazon\Rest\FulfillmentInboundApi\Model\DateStringType',
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApi\Model\Address $ship_from_address The return address.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApi\Model\DateStringType $confirmed_need_by_date Date by which the shipment must arrive at the Amazon fulfillment center to avoid delivery promise breaks for pre-ordered items.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\FulfillmentInboundApi\Model\BoxContentsSource
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApi\Model\BoxContentsSource $box_contents_source box_contents_source
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\FulfillmentInboundApi\Model\BoxContentsFeeDetails
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApi\Model\BoxContentsFeeDetails $estimated_box_contents_fee An estimate of the manual processing fee charged by Amazon for boxes without box content information. This is only returned when BoxContentsSource is NONE.
     *
     * @return $this
     */
