...
class FeesApi
{
    ...
    public function getMyFeesEstimateForASINWithHttpInfo($asin, $body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\ProductFeesApi\Model\GetMyFeesEstimateResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\ProductFeesApi\Model\GetMyFeesEstimateResponse', []),
