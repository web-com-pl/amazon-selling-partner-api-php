<?php
/**
 * GetFulfillmentPreviewItem20200701
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * GetFulfillmentPreviewItem20200701 Class Doc Comment
 *
 * @category Class
 ...
 */
class GetFulfillmentPreviewItem20200701 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSellerSku($sellerSku)
    {
        if ((mb_strlen($sellerSku) > 50)) {
            throw new \InvalidArgumentException('invalid length for $sellerSku when calling GetFulfillmentPreviewItem20200701., must be smaller than or equal to 50.');
        }
    ...
    public function setSellerFulfillmentOrderItemId($sellerFulfillmentOrderItemId)
    {
        if ((mb_strlen($sellerFulfillmentOrderItemId) > 50)) {
            throw new \InvalidArgumentException('invalid length for $sellerFulfillmentOrderItemId when calling GetFulfillmentPreviewItem20200701., must be smaller than or equal to 50.');
        }
