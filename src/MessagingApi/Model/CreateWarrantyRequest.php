...
class CreateWarrantyRequest implements ModelInterface, ArrayAccess
{
     ...
     * Gets attachments
     *
     * @return \Webcom\Amazon\Rest\MessagingApi\Model\Attachment[]
     */
     ...
     * Sets attachments
     *
     * @param \Webcom\Amazon\Rest\MessagingApi\Model\Attachment[] $attachments Attachments to include in the message to the buyer. If any text is included in the attachment, the text must be written in the buyer's language of preference, which can be retrieved from the GetAttributes operation.
     *
     * @return $this
     */
