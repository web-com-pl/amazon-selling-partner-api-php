...
class OfferType implements ModelInterface, ArrayAccess
{
     ...
     * Sets buying_price
     *
     * @param \Webcom\Amazon\Rest\ProductPricingApi\Model\PriceType $buying_price Contains pricing information that includes promotions and contains the shipping cost.
     *
     * @return $this
     */
     ...
     * Sets regular_price
     *
     * @param \Webcom\Amazon\Rest\ProductPricingApi\Model\MoneyType $regular_price The current price excluding any promotions that apply to the product. Excludes the shipping cost.
     *
     * @return $this
     */
