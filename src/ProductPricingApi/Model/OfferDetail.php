...
class OfferDetail implements ModelInterface, ArrayAccess
{
     ...
     *
     * @return \Webcom\Amazon\Rest\ProductPricingApi\Model\SellerFeedbackType
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\ProductPricingApi\Model\SellerFeedbackType $seller_feedback_rating Information about the seller's feedback, including the percentage of positive feedback, and the total number of ratings received.
     *
     * @return $this
     */
     ...
     * Sets shipping_time
     *
     * @param \Webcom\Amazon\Rest\ProductPricingApi\Model\DetailedShippingTimeType $shipping_time The maximum time within which the item will likely be shipped once an order has been placed.
     *
     * @return $this
     */
     ...
     * Gets ships_from
     *
     * @return \Webcom\Amazon\Rest\ProductPricingApi\Model\ShipsFromType
     */
     ...
     * Sets ships_from
     *
     * @param \Webcom\Amazon\Rest\ProductPricingApi\Model\ShipsFromType $ships_from The state and country from where the item is shipped.
     *
     * @return $this
     */
