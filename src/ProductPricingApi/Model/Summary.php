...
class Summary implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'number_of_offers' => '\Webcom\Amazon\Rest\ProductPricingApi\Model\NumberOfOffers',
        'lowest_prices' => '\Webcom\Amazon\Rest\ProductPricingApi\Model\LowestPrices',
        'buy_box_prices' => '\Webcom\Amazon\Rest\ProductPricingApi\Model\BuyBoxPrices',
        ...
        'buy_box_eligible_offers' => '\Webcom\Amazon\Rest\ProductPricingApi\Model\BuyBoxEligibleOffers',
     ...
     *
     * @return \Webcom\Amazon\Rest\ProductPricingApi\Model\NumberOfOffers
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\ProductPricingApi\Model\NumberOfOffers $number_of_offers A list that contains the total number of offers for the item for the given conditions and fulfillment channels.
     *
     * @return $this
     */
     ...
     * Gets lowest_prices
     *
     * @return \Webcom\Amazon\Rest\ProductPricingApi\Model\LowestPrices
     */
     ...
     * Sets lowest_prices
     *
     * @param \Webcom\Amazon\Rest\ProductPricingApi\Model\LowestPrices $lowest_prices A list of the lowest prices for the item.
     *
     * @return $this
     */
     ...
     * Gets buy_box_prices
     *
     * @return \Webcom\Amazon\Rest\ProductPricingApi\Model\BuyBoxPrices
     */
     ...
     * Sets buy_box_prices
     *
     * @param \Webcom\Amazon\Rest\ProductPricingApi\Model\BuyBoxPrices $buy_box_prices A list of item prices.
     *
     * @return $this
     */
     ...
     * Sets list_price
     *
     * @param \Webcom\Amazon\Rest\ProductPricingApi\Model\MoneyType $list_price The list price of the item as suggested by the manufacturer.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\ProductPricingApi\Model\MoneyType $suggested_lower_price_plus_shipping The suggested lower price of the item, including shipping and Amazon Points. The suggested lower price is based on a range of factors, including historical selling prices, recent Buy Box-eligible prices, and input from customers for your products.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\ProductPricingApi\Model\BuyBoxEligibleOffers
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\ProductPricingApi\Model\BuyBoxEligibleOffers $buy_box_eligible_offers A list that contains the total number of offers that are eligible for the Buy Box for the given conditions and fulfillment channels.
     *
     * @return $this
     */
