...
class CreateDestinationRequest implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Webcom\Amazon\Rest\NotificationsApi\Model\DestinationResourceSpecification $resource_specification The information required to create a destination resource. Applications should use one resource type (sqs or eventBridge) per destination.
     *
     * @return $this
     */
