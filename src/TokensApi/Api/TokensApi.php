...
namespace Webcom\Amazon\Rest\TokensApi\Api;
...
use Webcom\Amazon\Rest\TokensApi\ApiException;
...
class TokensApi
{
     ...
     *
     * @param  \Webcom\Amazon\Rest\TokensApi\Model\CreateRestrictedDataTokenRequest $body The restricted data token request details. (required)
     *
     * @throws \Webcom\Amazon\Rest\TokensApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\TokensApi\Model\CreateRestrictedDataTokenResponse|\Webcom\Amazon\Rest\TokensApi\Model\ErrorList|\Webcom\Amazon\Rest\TokensApi\Model\ErrorList|\Webcom\Amazon\Rest\TokensApi\Model\ErrorList|\Webcom\Amazon\Rest\TokensApi\Model\ErrorList|\Webcom\Amazon\Rest\TokensApi\Model\ErrorList|\Webcom\Amazon\Rest\TokensApi\Model\ErrorList|\Webcom\Amazon\Rest\TokensApi\Model\ErrorList|\Webcom\Amazon\Rest\TokensApi\Model\ErrorList
     */
    ...
    public function createRestrictedDataTokenWithHttpInfo($body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\TokensApi\Model\CreateRestrictedDataTokenResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\TokensApi\Model\CreateRestrictedDataTokenResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\Webcom\Amazon\Rest\TokensApi\Model\ErrorList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\TokensApi\Model\ErrorList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Webcom\Amazon\Rest\TokensApi\Model\CreateRestrictedDataTokenResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\TokensApi\Model\CreateRestrictedDataTokenResponse',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\TokensApi\Model\ErrorList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
