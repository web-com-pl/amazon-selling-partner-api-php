...
class FulfillmentOrder implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'displayable_order_date' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp',
        ...
        'received_date' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp',
        'fulfillment_order_status' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\FulfillmentOrderStatus',
        'status_updated_date' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp',
        'notification_emails' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\NotificationEmailList',
     ...
     *
     * @return \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp $displayable_order_date A date and time submitted with the createFulfillmentOrder operation. Displays as the order date in recipient-facing materials such as the packing slip.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\DeliveryWindow $delivery_window delivery_window
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Address $destination_address The destination address submitted with the createFulfillmentOrder operation.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\FulfillmentAction
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\FulfillmentAction $fulfillment_action fulfillment_action
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\FulfillmentPolicy
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\FulfillmentPolicy $fulfillment_policy fulfillment_policy
     *
     * @return $this
     */
     ...
     * Gets cod_settings
     *
     * @return \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\CODSettings
     */
     ...
     * Sets cod_settings
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\CODSettings $cod_settings cod_settings
     *
     * @return $this
     */
     ...
     * Sets received_date
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp $received_date The date and time that the fulfillment order was received by an Amazon fulfillment center.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp $status_updated_date The date and time that the status of the fulfillment order last changed, in ISO 8601 date time format.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\NotificationEmailList
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\NotificationEmailList $notification_emails notification_emails
     *
     * @return $this
     */
