...
class CreateFulfillmentOrderRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'items' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\CreateFulfillmentOrderItemList'
    ];
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp $displayable_order_date The date and time of the fulfillment order. Displays as the order date in recipient-facing materials such as the outbound shipment packing slip.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\ShippingSpeedCategory $shipping_speed_category The shipping method for the fulfillment order.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Address $destination_address The destination address for the fulfillment order.
     *
     * @return $this
     */
     ...
     * Gets items
     *
     * @return \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\CreateFulfillmentOrderItemList
     */
     ...
     * Sets items
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\CreateFulfillmentOrderItemList $items A list of items to include in the fulfillment order preview, including quantity.
     *
     * @return $this
     */
