...
class FulfillmentShipmentPackage implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp $estimated_arrival_date The estimated arrival date and time of the package, in ISO 8601 date time format.
     *
     * @return $this
     */
