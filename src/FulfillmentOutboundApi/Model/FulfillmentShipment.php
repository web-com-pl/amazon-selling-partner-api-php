...
class FulfillmentShipment implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'shipping_date' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp',
        'estimated_arrival_date' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp',
        'shipping_notes' => 'string[]',
        'fulfillment_shipment_item' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\FulfillmentShipmentItemList',
        'fulfillment_shipment_package' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\FulfillmentShipmentPackageList'
    ];
     ...
     * Sets shipping_date
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp $shipping_date The meaning of the shippingDate value depends on the current status of the shipment. If the current value of FulfillmentShipmentStatus is:  * Pending - shippingDate represents the estimated time that the shipment will leave the Amazon fulfillment center.  * Shipped - shippingDate represents the date that the shipment left the Amazon fulfillment center. If a shipment includes more than one package, shippingDate applies to all of the packages in the shipment. If the value of FulfillmentShipmentStatus is CancelledByFulfiller or CancelledBySeller, shippingDate is not returned. The value must be in ISO 8601 date time format.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\FulfillmentShipmentItemList
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\FulfillmentShipmentItemList $fulfillment_shipment_item fulfillment_shipment_item
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\FulfillmentShipmentPackageList
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\FulfillmentShipmentPackageList $fulfillment_shipment_package fulfillment_shipment_package
     *
     * @return $this
     */
