...
class CreateFulfillmentReturnRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'items' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\CreateReturnItem[]'
    ];
     ...
     * Gets items
     *
     * @return \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\CreateReturnItem[]
     */
     ...
     * Sets items
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\CreateReturnItem[] $items An array of items to be returned.
     *
     * @return self
     */
