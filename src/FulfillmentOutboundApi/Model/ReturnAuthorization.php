...
class ReturnAuthorization implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Address $return_to_address The address of the Amazon fulfillment center that the return items should be sent to.
     *
     * @return $this
     */
