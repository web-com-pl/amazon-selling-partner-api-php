...
class ReturnItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'status_changed_date' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp',
     ...
     * Gets status
     *
     * @return \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\FulfillmentReturnItemStatus
     */
     ...
     * Sets status
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\FulfillmentReturnItemStatus $status Indicates if the return item has been processed by an Amazon fulfillment center.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp $status_changed_date Indicates when the status last changed.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\ReturnItemDisposition
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\ReturnItemDisposition $return_received_condition return_received_condition
     *
     * @return $this
     */
