...
class FulfillmentOrderItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'quantity' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Quantity',
        'gift_message' => 'string',
        'displayable_comment' => 'string',
        'fulfillment_network_sku' => 'string',
        'order_item_disposition' => 'string',
        'cancelled_quantity' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Quantity',
        'unfulfillable_quantity' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Quantity',
        'estimated_ship_date' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp',
        'estimated_arrival_date' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp',
     ...
     * Gets quantity
     *
     * @return \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Quantity
     */
     ...
     * Sets quantity
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Quantity $quantity quantity
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Quantity $cancelled_quantity The item quantity that was cancelled by the seller.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Quantity $unfulfillable_quantity The item quantity that is unfulfillable.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp $estimated_arrival_date The estimated arrival date and time of the item quantity. Note that this value can change over time. If the shipment that contains the item quantity has been cancelled, estimatedArrivalDate is not returned.
     *
     * @return $this
     */
     ...
     * Gets per_unit_price
     *
     * @return \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Money
     */
     ...
     * Sets per_unit_price
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Money $per_unit_price The amount to be collected from the recipient for this item in a COD (Cash On Delivery) order.
     *
     * @return $this
     */
     ...
     * Sets per_unit_tax
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Money $per_unit_tax The tax on the amount to be collected from the recipient for this item in a COD (Cash On Delivery) order.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Money $per_unit_declared_value The monetary value assigned by the seller to this item.
     *
     * @return $this
     */
