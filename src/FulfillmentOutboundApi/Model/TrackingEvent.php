...
class TrackingEvent implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'event_date' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp',
     ...
     * Sets event_date
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp $event_date The date and time that the delivery event took place, in ISO 8601 date time format.
     *
     * @return $this
     */
     ...
     * Sets event_address
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\TrackingAddress $event_address The city where the delivery event took place.
     *
     * @return $this
     */
     ...
     * Sets event_code
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\EventCode $event_code The event code for the delivery event.
     *
     * @return $this
     */
