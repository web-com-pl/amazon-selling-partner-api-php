...
class FulfillmentPreviewShipment implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'earliest_ship_date' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp',
        'latest_ship_date' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp',
        'earliest_arrival_date' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp',
        'latest_arrival_date' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp',
        'shipping_notes' => 'string[]',
        'fulfillment_preview_items' => '\Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\FulfillmentPreviewItemList'
    ];
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp $earliest_ship_date The earliest date that the shipment is expected to be sent from the fulfillment center, in ISO 8601 date time format.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp $latest_ship_date The latest date that the shipment is expected to be sent from the fulfillment center, in ISO 8601 date time format.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp $earliest_arrival_date The earliest date that the shipment is expected to arrive at its destination.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\Timestamp $latest_arrival_date The latest date that the shipment is expected to arrive at its destination, in ISO 8601 date time format.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\FulfillmentPreviewItemList
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\FulfillmentOutboundApi\Model\FulfillmentPreviewItemList $fulfillment_preview_items Information about the items in the shipment.
     *
     * @return $this
     */
