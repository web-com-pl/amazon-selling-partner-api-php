<?php
/**
 * PartneredSmallParcelDataOutputV0
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * PartneredSmallParcelDataOutputV0 Class Doc Comment
 *
 * @category Class
 ...
 */
class PartneredSmallParcelDataOutputV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'packageList' => '\Webcom\Amazon\Rest\FulfillmentInboundApiV0\Model\PartneredSmallParcelPackageOutputV0[]',
     ...
     * Gets packageList
     *
     * @return \Webcom\Amazon\Rest\FulfillmentInboundApiV0\Model\PartneredSmallParcelPackageOutputV0[]
     */
     ...
     * Sets packageList
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApiV0\Model\PartneredSmallParcelPackageOutputV0[] $packageList A list of packages, including shipping information from the Amazon-partnered carrier.
     *
     * @return self
     */
