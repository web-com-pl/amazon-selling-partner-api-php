 ...
 */
class PalletV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets weight
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApiV0\Model\WeightV0|null $weight weight
     *
     * @return self
     */
