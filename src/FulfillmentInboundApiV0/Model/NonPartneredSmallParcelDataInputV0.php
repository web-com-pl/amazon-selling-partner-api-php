<?php
/**
 * NonPartneredSmallParcelDataInputV0
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * NonPartneredSmallParcelDataInputV0 Class Doc Comment
 *
 * @category Class
 ...
 */
class NonPartneredSmallParcelDataInputV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'carrierName' => 'string',
        'packageList' => '\Webcom\Amazon\Rest\FulfillmentInboundApiV0\Model\NonPartneredSmallParcelPackageInputV0[]'
    ];
     ...
     * Gets packageList
     *
     * @return \Webcom\Amazon\Rest\FulfillmentInboundApiV0\Model\NonPartneredSmallParcelPackageInputV0[]
     */
     ...
     * Sets packageList
     *
     * @param \Webcom\Amazon\Rest\FulfillmentInboundApiV0\Model\NonPartneredSmallParcelPackageInputV0[] $packageList A list of package tracking information.
     *
     * @return self
     */
