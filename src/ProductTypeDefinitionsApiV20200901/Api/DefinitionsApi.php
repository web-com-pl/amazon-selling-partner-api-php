...
namespace Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Api;
...
use Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\ApiException;
...
class DefinitionsApi
{
     ...
     *
     * @throws \Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ProductTypeDefinition|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList
     */
     ...
     * @throws \Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ProductTypeDefinition|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDefinitionsProductTypeWithHttpInfo($productType, $marketplaceIds, $sellerId = null, $productTypeVersion = 'LATEST', $requirements = 'LISTING', $requirementsEnforced = 'ENFORCED', $locale = 'DEFAULT')
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ProductTypeDefinition' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ProductTypeDefinition', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ProductTypeDefinition';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ProductTypeDefinition',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ProductTypeList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList
     */
     ...
     * @throws \Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ProductTypeList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ErrorList, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchDefinitionsProductTypesWithHttpInfo($marketplaceIds, $keywords = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ProductTypeList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ProductTypeList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ProductTypeList';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\ProductTypeDefinitionsApiV20200901\Model\ProductTypeList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
