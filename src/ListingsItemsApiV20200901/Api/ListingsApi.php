...
namespace Webcom\Amazon\Rest\ListingsItemsApiV20200901\Api;
...
use Webcom\Amazon\Rest\ListingsItemsApiV20200901\ApiException;
...
class ListingsApi
{
     ...
     *
     * @throws \Webcom\Amazon\Rest\ListingsItemsApiV20200901\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\ListingsItemsApiV20200901\Model\ListingsItemSubmissionResponse|\Webcom\Amazon\Rest\ListingsItemsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApiV20200901\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApiV20200901\Model\ErrorList
     */
    ...
    public function deleteListingsItemWithHttpInfo($sellerId, $sku, $marketplaceIds, $issueLocale = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\ListingsItemsApiV20200901\Model\ListingsItemSubmissionResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\ListingsItemsApiV20200901\Model\ListingsItemSubmissionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\Webcom\Amazon\Rest\ListingsItemsApiV20200901\Model\ErrorList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\ListingsItemsApiV20200901\Model\ErrorList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\Webcom\Amazon\Rest\ListingsItemsApiV20200901\Model\ListingsItemSubmissionResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\ListingsItemsApiV20200901\Model\ListingsItemSubmissionResponse',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\ListingsItemsApiV20200901\Model\ErrorList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $sku A selling partner provided identifier for an Amazon listing. (required)
     * @param  string[] $marketplaceIds A comma-delimited list of Amazon marketplace identifiers for the request. (required)
     * @param  \Webcom\Amazon\Rest\ListingsItemsApiV20200901\Model\ListingsItemPatchRequest $body The request body schema for the patchListingsItem operation. (required)
     * @param  string $issueLocale A locale for localization of issues. When not provided, the default language code of the first marketplace is used. Examples: \&quot;en_US\&quot;, \&quot;fr_CA\&quot;, \&quot;fr_FR\&quot;. Localized messages default to \&quot;en_US\&quot; when a localization is not available in the specified locale. (optional)
     *
     * @throws \Webcom\Amazon\Rest\ListingsItemsApiV20200901\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  string $sku A selling partner provided identifier for an Amazon listing. (required)
     * @param  string[] $marketplaceIds A comma-delimited list of Amazon marketplace identifiers for the request. (required)
     * @param  \Webcom\Amazon\Rest\ListingsItemsApiV20200901\Model\ListingsItemPutRequest $body The request body schema for the putListingsItem operation. (required)
     * @param  string $issueLocale A locale for localization of issues. When not provided, the default language code of the first marketplace is used. Examples: \&quot;en_US\&quot;, \&quot;fr_CA\&quot;, \&quot;fr_FR\&quot;. Localized messages default to \&quot;en_US\&quot; when a localization is not available in the specified locale. (optional)
     *
     * @throws \Webcom\Amazon\Rest\ListingsItemsApiV20200901\ApiException on non-2xx response
     * @throws \InvalidArgumentException
