...
class OrderMetricsInterval implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Webcom\Amazon\Rest\SalesApi\Model\Money $average_unit_price The average price for an item based on the specified filters. Formula is totalSales/unitCount.
     *
     * @return $this
     */
     ...
     * Sets total_sales
     *
     * @param \Webcom\Amazon\Rest\SalesApi\Model\Money $total_sales The total ordered product sales for all orders based on the specified filters.
     *
     * @return $this
     */
