 ...
 *
 * The Selling Partner API for Listings Restrictions provides programmatic access to restrictions on Amazon catalog listings.  For more information, see the [Listings Restrictions API use Webcom\Amazon\Rest\ModelInterface;
 * Use Case Guide](https://github.com/amzn/selling-partner-api-docs/blob/main/guides/en-US/use-case-guides/listings-restrictions-api-use-case-guide/listings-restrictions-api-use-case-guide_2021-08-01.md).
 *
...
namespace Webcom\Amazon\Rest\ListingsRestrictionsApi\Model;
...
class Reason implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'message'    => 'string',
        'reasonCode' => 'string',
        'links'      => '\Webcom\Amazon\Rest\ListingsRestrictionsApi\Model\Link[]'
    ];
    /**
     ...
     * Gets links
     *
     * @return \Webcom\Amazon\Rest\ListingsRestrictionsApi\Model\Link[]|null
     */
     ...
     * Sets links
     *
     * @param \Webcom\Amazon\Rest\ListingsRestrictionsApi\Model\Link[]|null $links A list of path forward links that may allow Selling Partners to remove the restriction.
     *
     * @return self
     */
