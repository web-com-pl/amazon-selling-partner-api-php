 ...
 *
 * @category Class
 * @package  Webcom\Amazon\Rest\ListingsRestrictionsApi
...
namespace Webcom\Amazon\Rest\ListingsRestrictionsApi\Api;
...
use Webcom\Amazon\Rest\ListingsRestrictionsApi\ApiException;
...
class ListingsApi
{
     ...
     *
     * @return \Webcom\Amazon\Rest\ListingsRestrictionsApi\Model\RestrictionList|\Webcom\Amazon\Rest\ListingsRestrictionsApi\Model\Error[]|\Webcom\Amazon\Rest\ListingsRestrictionsApi\Model\Error[]|\Webcom\Amazon\Rest\ListingsRestrictionsApi\Model\Error[]|\Webcom\Amazon\Rest\ListingsRestrictionsApi\Model\Error[]|\Webcom\Amazon\Rest\ListingsRestrictionsApi\Model\Error[]|\Webcom\Amazon\Rest\ListingsRestrictionsApi\Model\Error[]|\Webcom\Amazon\Rest\ListingsRestrictionsApi\Model\Error[]|\Webcom\Amazon\Rest\ListingsRestrictionsApi\Model\Error[]
     * @throws \InvalidArgumentException
     * @throws \Webcom\Amazon\Rest\ListingsRestrictionsApi\ApiException on non-2xx response
     */
    ...
    public function getListingsRestrictionsWithHttpInfo($asin, $sellerId, $marketplaceIds, $conditionType = null, $reasonLocale = null)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\ListingsRestrictionsApi\Model\RestrictionList' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\ListingsRestrictionsApi\Model\RestrictionList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\Webcom\Amazon\Rest\ListingsRestrictionsApi\Model\Error[]' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\ListingsRestrictionsApi\Model\Error[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\Webcom\Amazon\Rest\ListingsRestrictionsApi\Model\RestrictionList';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\ListingsRestrictionsApi\Model\RestrictionList',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\ListingsRestrictionsApi\Model\Error[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
