...
namespace Webcom\Amazon\Rest\EasyShip\Api;
...
use Webcom\Amazon\Rest\EasyShip\ApiException;
...
class EasyShipApi
{
     ...
     *
     * @param  \Webcom\Amazon\Rest\EasyShip\Model\CreateScheduledPackageRequest $createScheduledPackageRequest createScheduledPackageRequest (required)
     *
     * @throws \Webcom\Amazon\Rest\EasyShip\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\EasyShip\Model\Package|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList
     */
     ...
     *
     * @param  \Webcom\Amazon\Rest\EasyShip\Model\CreateScheduledPackageRequest $createScheduledPackageRequest (required)
     *
     * @throws \Webcom\Amazon\Rest\EasyShip\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\EasyShip\Model\Package|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList, HTTP status code, HTTP response headers (array of strings)
     */
    public function createScheduledPackageWithHttpInfo($createScheduledPackageRequest)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\EasyShip\Model\Package' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\EasyShip\Model\Package', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\Webcom\Amazon\Rest\EasyShip\Model\ErrorList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\EasyShip\Model\ErrorList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Webcom\Amazon\Rest\EasyShip\Model\Package';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\EasyShip\Model\Package',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\EasyShip\Model\ErrorList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Webcom\Amazon\Rest\EasyShip\Model\ListHandoverSlotsRequest $listHandoverSlotsRequest listHandoverSlotsRequest (optional)
     *
     * @throws \Webcom\Amazon\Rest\EasyShip\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\EasyShip\Model\ListHandoverSlotsResponse|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList
     */
     ...
     *
     * @param  \Webcom\Amazon\Rest\EasyShip\Model\ListHandoverSlotsRequest $listHandoverSlotsRequest (optional)
     *
     * @throws \Webcom\Amazon\Rest\EasyShip\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\EasyShip\Model\ListHandoverSlotsResponse|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList, HTTP status code, HTTP response headers (array of strings)
     */
    public function listHandoverSlotsWithHttpInfo($listHandoverSlotsRequest = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\EasyShip\Model\ListHandoverSlotsResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\EasyShip\Model\ListHandoverSlotsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Webcom\Amazon\Rest\EasyShip\Model\ListHandoverSlotsResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\EasyShip\Model\ListHandoverSlotsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Webcom\Amazon\Rest\EasyShip\Model\UpdateScheduledPackagesRequest $updateScheduledPackagesRequest updateScheduledPackagesRequest (optional)
     *
     * @throws \Webcom\Amazon\Rest\EasyShip\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\EasyShip\Model\Packages|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList
     */
     ...
     *
     * @param  \Webcom\Amazon\Rest\EasyShip\Model\UpdateScheduledPackagesRequest $updateScheduledPackagesRequest (optional)
     *
     * @throws \Webcom\Amazon\Rest\EasyShip\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\EasyShip\Model\Packages|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList|\Webcom\Amazon\Rest\EasyShip\Model\ErrorList, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateScheduledPackagesWithHttpInfo($updateScheduledPackagesRequest = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\EasyShip\Model\Packages' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\EasyShip\Model\Packages', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Webcom\Amazon\Rest\EasyShip\Model\Packages';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\EasyShip\Model\Packages',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
