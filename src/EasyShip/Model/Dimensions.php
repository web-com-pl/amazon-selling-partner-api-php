...
class Dimensions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'width' => 'float',
        'height' => 'float',
        'unit' => '\Webcom\Amazon\Rest\EasyShip\Model\UnitOfLength',
        'identifier' => 'string'
    ];
     ...
     * Gets unit
     *
     * @return \Webcom\Amazon\Rest\EasyShip\Model\UnitOfLength|null
     */
     ...
     * Sets unit
     *
     * @param \Webcom\Amazon\Rest\EasyShip\Model\UnitOfLength|null $unit unit
     *
     * @return self
     */
