...
namespace Webcom\Amazon\Rest\ListingsItemsApi\Api;
...
use Webcom\Amazon\Rest\ListingsItemsApi\ApiException;
...
class ListingsApi
{
     ...
     *
     * @throws \Webcom\Amazon\Rest\ListingsItemsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\ListingsItemsApi\Model\ListingsItemSubmissionResponse|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList
     */
     ...
     * @throws \Webcom\Amazon\Rest\ListingsItemsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\ListingsItemsApi\Model\ListingsItemSubmissionResponse|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteListingsItemWithHttpInfo($sellerId, $sku, $marketplaceIds, $issueLocale = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\ListingsItemsApi\Model\ListingsItemSubmissionResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\ListingsItemsApi\Model\ListingsItemSubmissionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\Webcom\Amazon\Rest\ListingsItemsApi\Model\ListingsItemSubmissionResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\ListingsItemsApi\Model\ListingsItemSubmissionResponse',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Webcom\Amazon\Rest\ListingsItemsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\ListingsItemsApi\Model\Item|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList
     */
     ...
     * @throws \Webcom\Amazon\Rest\ListingsItemsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\ListingsItemsApi\Model\Item|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\ListingsItemsApi\Model\ErrorList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getListingsItemWithHttpInfo($sellerId, $sku, $marketplaceIds, $issueLocale = null, $includedData = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\ListingsItemsApi\Model\Item' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\ListingsItemsApi\Model\Item', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Webcom\Amazon\Rest\ListingsItemsApi\Model\Item';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\ListingsItemsApi\Model\Item',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $sku A selling partner provided identifier for an Amazon listing. (required)
     * @param  string[] $marketplaceIds A comma-delimited list of Amazon marketplace identifiers for the request. (required)
     * @param  \Webcom\Amazon\Rest\ListingsItemsApi\Model\ListingsItemPatchRequest $body The request body schema for the patchListingsItem operation. (required)
     * @param  string $issueLocale A locale for localization of issues. When not provided, the default language code of the first marketplace is used. Examples: \&quot;en_US\&quot;, \&quot;fr_CA\&quot;, \&quot;fr_FR\&quot;. Localized messages default to \&quot;en_US\&quot; when a localization is not available in the specified locale. (optional)
     *
     * @throws \Webcom\Amazon\Rest\ListingsItemsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  string $sku A selling partner provided identifier for an Amazon listing. (required)
     * @param  string[] $marketplaceIds A comma-delimited list of Amazon marketplace identifiers for the request. (required)
     * @param  \Webcom\Amazon\Rest\ListingsItemsApi\Model\ListingsItemPutRequest $body The request body schema for the putListingsItem operation. (required)
     * @param  string $issueLocale A locale for localization of issues. When not provided, the default language code of the first marketplace is used. Examples: \&quot;en_US\&quot;, \&quot;fr_CA\&quot;, \&quot;fr_FR\&quot;. Localized messages default to \&quot;en_US\&quot; when a localization is not available in the specified locale. (optional)
     *
     * @throws \Webcom\Amazon\Rest\ListingsItemsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
