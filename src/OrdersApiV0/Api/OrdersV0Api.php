...
class OrdersV0Api
{
     ...
     *
     * @param  string $orderId An orderId is an Amazon-defined order identifier, in 3-7-7 format. (required)
     * @param  \Webcom\Amazon\Rest\OrdersApiV0\Model\UpdateVerificationStatusRequestV0 $payload Request to update the verification status of an order containing regulated products. (required)
     *
     * @throws \Webcom\Amazon\Rest\OrdersApiV0\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
