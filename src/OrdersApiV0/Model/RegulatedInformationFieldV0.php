...
class RegulatedInformationFieldV0 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets fieldLabel
     *
     * @param string $fieldLabel The human-readable name for the field.
     *
     * @return self
     */
     ...
     * Sets fieldType
     *
     * @param string $fieldType The type of field the field.
     *
     * @return self
     */
     ...
     * Sets fieldValue
     *
     * @param string $fieldValue The content of the field as collected in regulatory form. Note that FileAttachment type fields will contain an URL to download the attachment here.
     *
     * @return self
     */
