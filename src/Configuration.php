...
class Configuration
{
    ...
    /**
     * Restricted Data Token (RDT) for one or more restricted resources that you specify.
     *
     * @var RestrictedDataToken|null
     * @see https://github.com/amzn/selling-partner-api-docs/blob/main/references/tokens-api/tokens_2021-03-01.md#overview
     */
    protected ?RestrictedDataToken $restrictedDataToken = null;
