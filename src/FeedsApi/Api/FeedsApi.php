...
namespace Webcom\Amazon\Rest\FeedsApi\Api;
...
use Webcom\Amazon\Rest\FeedsApi\ApiException;
...
class FeedsApi
{
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList',
     ...
     *
     * @param  \Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedSpecification $body body (required)
     *
     * @throws \Webcom\Amazon\Rest\FeedsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedResponse|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList
     */
     ...
     *
     * @param  \Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedSpecification $body (required)
     *
     * @throws \Webcom\Amazon\Rest\FeedsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedResponse|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList, HTTP status code, HTTP response headers (array of strings)
     */
    public function createFeedWithHttpInfo($body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 202:
                    if ('\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentSpecification $body body (required)
     *
     * @throws \Webcom\Amazon\Rest\FeedsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList
     */
     ...
     *
     * @param  \Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentSpecification $body (required)
     *
     * @throws \Webcom\Amazon\Rest\FeedsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList, HTTP status code, HTTP response headers (array of strings)
     */
    public function createFeedDocumentWithHttpInfo($body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Webcom\Amazon\Rest\FeedsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\FeedsApi\Model\Feed|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList
     */
     ...
     * @throws \Webcom\Amazon\Rest\FeedsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\FeedsApi\Model\Feed|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFeedWithHttpInfo($feedId)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\FeedsApi\Model\Feed' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\FeedsApi\Model\Feed', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Webcom\Amazon\Rest\FeedsApi\Model\Feed';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\FeedsApi\Model\Feed',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Webcom\Amazon\Rest\FeedsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\FeedsApi\Model\FeedDocument|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList
     */
     ...
     * @throws \Webcom\Amazon\Rest\FeedsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\FeedsApi\Model\FeedDocument|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFeedDocumentWithHttpInfo($feedDocumentId)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\FeedsApi\Model\FeedDocument' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\FeedsApi\Model\FeedDocument', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Webcom\Amazon\Rest\FeedsApi\Model\FeedDocument';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\FeedsApi\Model\FeedDocument',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Webcom\Amazon\Rest\FeedsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\FeedsApi\Model\GetFeedsResponse|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList
     */
     ...
     * @throws \Webcom\Amazon\Rest\FeedsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\FeedsApi\Model\GetFeedsResponse|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList|\Webcom\Amazon\Rest\FeedsApi\Model\ErrorList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFeedsWithHttpInfo($feedTypes = null, $marketplaceIds = null, $pageSize = 10, $processingStatuses = null, $createdSince = null, $createdUntil = null, $nextToken = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\FeedsApi\Model\GetFeedsResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\FeedsApi\Model\GetFeedsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\FeedsApi\Model\GetFeedsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
