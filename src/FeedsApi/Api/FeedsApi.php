...
class FeedsApi
{
    ...
    public function cancelFeedWithHttpInfo($feed_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\FeedsApi\Model\CancelFeedResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\FeedsApi\Model\CancelFeedResponse', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\FeedsApi\Model\CancelFeedResponse',
     ...
     * @throws \Webcom\Amazon\Rest\FeedsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse|\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse|\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse|\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse|\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse|\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse|\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse|\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse|\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse
     */
     ...
     * @throws \Webcom\Amazon\Rest\FeedsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse|\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse|\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse|\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse|\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse|\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse|\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse|\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse|\Webcom\Amazon\Rest\FeedsApi\Model\CreateFeedDocumentResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getFeedWithHttpInfo($feed_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\FeedsApi\Model\GetFeedResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\FeedsApi\Model\GetFeedResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\FeedsApi\Model\GetFeedResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getFeedDocumentWithHttpInfo($feed_document_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\FeedsApi\Model\GetFeedDocumentResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\FeedsApi\Model\GetFeedDocumentResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\FeedsApi\Model\GetFeedDocumentResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
