...
namespace Webcom\Amazon\Rest\ListingsRestrictionsApiV20210801\Model;
...
class Reason implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'message' => 'string',
        'reasonCode' => 'string',
        'links' => '\Webcom\Amazon\Rest\ListingsRestrictionsApiV20210801\Model\Link[]'
    ];
     ...
     * Gets links
     *
     * @return \Webcom\Amazon\Rest\ListingsRestrictionsApiV20210801\Model\Link[]|null
     */
     ...
     * Sets links
     *
     * @param \Webcom\Amazon\Rest\ListingsRestrictionsApiV20210801\Model\Link[]|null $links A list of path forward links that may allow Selling Partners to remove the restriction.
     *
     * @return self
     */
