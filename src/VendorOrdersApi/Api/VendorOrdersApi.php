...
class VendorOrdersApi
{
     ...
     * @param  string $itemConfirmationStatus Filters purchase orders based on the specified purchase order item status. If not included in filter, purchase orders for all statuses are included. (optional)
     ...
     */
    public function getPurchaseOrdersStatus($limit = null, $sortOrder = null, $nextToken = null, $createdAfter = null, $createdBefore = null, $updatedAfter = null, $updatedBefore = null, $purchaseOrderNumber = null, $purchaseOrderStatus = null, $itemConfirmationStatus = null, $orderingVendorCode = null, $shipToPartyId = null)
    {
        list($response) = $this->getPurchaseOrdersStatusWithHttpInfo($limit, $sortOrder, $nextToken, $createdAfter, $createdBefore, $updatedAfter, $updatedBefore, $purchaseOrderNumber, $purchaseOrderStatus, $itemConfirmationStatus, $orderingVendorCode, $shipToPartyId);
        return $response;
    }
     ...
     */
    public function getPurchaseOrdersStatusWithHttpInfo($limit = null, $sortOrder = null, $nextToken = null, $createdAfter = null, $createdBefore = null, $updatedAfter = null, $updatedBefore = null, $purchaseOrderNumber = null, $purchaseOrderStatus = null, $itemConfirmationStatus = null, $orderingVendorCode = null, $shipToPartyId = null)
    {
        $request = $this->getPurchaseOrdersStatusRequest($limit, $sortOrder, $nextToken, $createdAfter, $createdBefore, $updatedAfter, $updatedBefore, $purchaseOrderNumber, $purchaseOrderStatus, $itemConfirmationStatus, $orderingVendorCode, $shipToPartyId);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPurchaseOrdersStatusAsync($limit = null, $sortOrder = null, $nextToken = null, $createdAfter = null, $createdBefore = null, $updatedAfter = null, $updatedBefore = null, $purchaseOrderNumber = null, $purchaseOrderStatus = null, $itemConfirmationStatus = null, $orderingVendorCode = null, $shipToPartyId = null)
    {
        return $this->getPurchaseOrdersStatusAsyncWithHttpInfo($limit, $sortOrder, $nextToken, $createdAfter, $createdBefore, $updatedAfter, $updatedBefore, $purchaseOrderNumber, $purchaseOrderStatus, $itemConfirmationStatus, $orderingVendorCode, $shipToPartyId)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPurchaseOrdersStatusAsyncWithHttpInfo($limit = null, $sortOrder = null, $nextToken = null, $createdAfter = null, $createdBefore = null, $updatedAfter = null, $updatedBefore = null, $purchaseOrderNumber = null, $purchaseOrderStatus = null, $itemConfirmationStatus = null, $orderingVendorCode = null, $shipToPartyId = null)
    {
        $returnType = '\Webcom\Amazon\Rest\VendorOrdersApi\Model\GetPurchaseOrdersStatusResponse';
        $request = $this->getPurchaseOrdersStatusRequest($limit, $sortOrder, $nextToken, $createdAfter, $createdBefore, $updatedAfter, $updatedBefore, $purchaseOrderNumber, $purchaseOrderStatus, $itemConfirmationStatus, $orderingVendorCode, $shipToPartyId);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPurchaseOrdersStatusRequest($limit = null, $sortOrder = null, $nextToken = null, $createdAfter = null, $createdBefore = null, $updatedAfter = null, $updatedBefore = null, $purchaseOrderNumber = null, $purchaseOrderStatus = null, $itemConfirmationStatus = null, $orderingVendorCode = null, $shipToPartyId = null)
    {
        if ($limit !== null && $limit > 100) {
