...
class SmallAndLightFeePreviewRequest implements ModelInterface, ArrayAccess
{
     ...
     * Gets items
     *
     * @return \Webcom\Amazon\Rest\FbaSmallAndLightApi\Model\Item[]
     */
     ...
     * Sets items
     *
     * @param \Webcom\Amazon\Rest\FbaSmallAndLightApi\Model\Item[] $items A list of items for which to retrieve fee estimates (limit: 25).
     *
     * @return $this
     */
