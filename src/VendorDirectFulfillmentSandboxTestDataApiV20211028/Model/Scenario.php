...
class Scenario implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'scenarioId' => 'string',
        'orders' => '\Webcom\Amazon\Rest\VendorDirectFulfillmentSandboxTestDataApiV20211028\Model\TestOrder[]'
    ];
     ...
     * Gets orders
     *
     * @return \Webcom\Amazon\Rest\VendorDirectFulfillmentSandboxTestDataApiV20211028\Model\TestOrder[]
     */
     ...
     * Sets orders
     *
     * @param \Webcom\Amazon\Rest\VendorDirectFulfillmentSandboxTestDataApiV20211028\Model\TestOrder[] $orders A list of orders that can be used by the caller to test each life cycle or scenario.
     *
     * @return self
     */
