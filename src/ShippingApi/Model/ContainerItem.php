...
class ContainerItem implements ModelInterface, ArrayAccess
{
     ...
     * Sets unit_price
     *
     * @param \Webcom\Amazon\Rest\ShippingApi\Model\Currency $unit_price The unit price of an item of this type (the total value of this item type in the container is unitPrice * quantity).
     *
     * @return $this
     */
     ...
     * Sets unit_weight
     *
     * @param \Webcom\Amazon\Rest\ShippingApi\Model\Weight $unit_weight The unit weight of an item of this type (the total weight of this item type in the container is unitWeight * quantity).
     *
     * @return $this
     */
