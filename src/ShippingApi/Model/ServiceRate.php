...
class ServiceRate implements ModelInterface, ArrayAccess
{
     ...
     * Sets total_charge
     *
     * @param \Webcom\Amazon\Rest\ShippingApi\Model\Currency $total_charge The total charge that will be billed for the rate.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\ShippingApi\Model\Weight $billable_weight The weight that was used to calculate the totalCharge.
     *
     * @return $this
     */
