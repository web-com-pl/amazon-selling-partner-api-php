...
class ShipmentRequestDetails implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'must_arrive_by_date' => '\Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\Timestamp',
        'ship_date' => '\Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\Timestamp',
        'shipping_service_options' => '\Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\ShippingServiceOptions',
        'label_customization' => '\Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\LabelCustomization'
    ];
     ...
     *
     * @param \Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\AmazonOrderId $amazon_order_id An Amazon-defined order identifier in 3-7-7 format.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\SellerOrderId $seller_order_id A seller-defined order identifier.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\PackageDimensions $package_dimensions The package dimensions.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\Timestamp $must_arrive_by_date The date by which the package must arrive to keep the promise to the customer, in ISO 8601 datetime format. If MustArriveByDate is specified, only shipping service offers that can be delivered by that date are returned.
     *
     * @return $this
     */
     ...
     * Sets ship_date
     *
     * @param \Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\Timestamp $ship_date When used in a request, this is the date and time that the seller wants to ship the package. When used in a response, this is the date and time that the package can be shipped by the indicated method.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\ShippingServiceOptions $shipping_service_options Extra services offered by the carrier.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\LabelCustomization
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\LabelCustomization $label_customization Label customization options.
     *
     * @return $this
     */
