...
class Item implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'order_item_id' => '\Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\OrderItemId',
        'quantity' => '\Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\ItemQuantity',
        'item_weight' => '\Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\Weight',
        'item_description' => '\Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\ItemDescription',
        'transparency_code_list' => '\Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\TransparencyCodeList',
        'item_level_seller_inputs_list' => '\Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\AdditionalSellerInputsList'
    ];
     ...
     * Gets order_item_id
     *
     * @return \Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\OrderItemId
     */
     ...
     * Sets order_item_id
     *
     * @param \Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\OrderItemId $order_item_id order_item_id
     *
     * @return $this
     */
     ...
     * Gets quantity
     *
     * @return \Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\ItemQuantity
     */
     ...
     * Sets quantity
     *
     * @param \Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\ItemQuantity $quantity quantity
     *
     * @return $this
     */
     ...
     * Sets item_weight
     *
     * @param \Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\Weight $item_weight item_weight
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\ItemDescription
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\ItemDescription $item_description item_description
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\TransparencyCodeList
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\TransparencyCodeList $transparency_code_list transparency_code_list
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\AdditionalSellerInputsList
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\MerchantFulfillmentApi\Model\AdditionalSellerInputsList $item_level_seller_inputs_list A list of additional seller inputs required to ship this item using the chosen shipping service.
     *
     * @return $this
     */
