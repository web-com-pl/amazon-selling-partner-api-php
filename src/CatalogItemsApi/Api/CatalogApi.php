...
class CatalogApi
{
     ...
     * @return \Webcom\Amazon\Rest\CatalogItemsApi\Model\Item|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList
     */
     ...
     * @throws \Webcom\Amazon\Rest\CatalogItemsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\CatalogItemsApi\Model\Item|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCatalogItemWithHttpInfo($asin, $marketplaceIds, $includedData = null, $locale = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\CatalogItemsApi\Model\Item' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\CatalogItemsApi\Model\Item', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\Webcom\Amazon\Rest\CatalogItemsApi\Model\Item';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\CatalogItemsApi\Model\Item',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Webcom\Amazon\Rest\CatalogItemsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\CatalogItemsApi\Model\ItemSearchResults|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList
     */
     ...
     * @throws \Webcom\Amazon\Rest\CatalogItemsApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\CatalogItemsApi\Model\ItemSearchResults|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList|\Webcom\Amazon\Rest\CatalogItemsApi\Model\ErrorList, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchCatalogItemsWithHttpInfo($keywords, $marketplaceIds, $includedData = null, $brandNames = null, $classificationIds = null, $pageSize = 10, $pageToken = null, $keywordsLocale = null, $locale = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\CatalogItemsApi\Model\ItemSearchResults' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\CatalogItemsApi\Model\ItemSearchResults', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Webcom\Amazon\Rest\CatalogItemsApi\Model\ItemSearchResults';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\CatalogItemsApi\Model\ItemSearchResults',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
