...
class ServiceJob implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'service_job_id' => '\Webcom\Amazon\Rest\ServicesApi\Model\ServiceJobId',
        ...
        'service_order_id' => '\Webcom\Amazon\Rest\ServicesApi\Model\OrderId',
     ...
     * Gets service_job_id
     *
     * @return \Webcom\Amazon\Rest\ServicesApi\Model\ServiceJobId
     */
     ...
     * Sets service_job_id
     *
     * @param \Webcom\Amazon\Rest\ServicesApi\Model\ServiceJobId $service_job_id The service job identifier.
     *
     * @return $this
     */
     ...
     * Gets scope_of_work
     *
     * @return \Webcom\Amazon\Rest\ServicesApi\Model\ScopeOfWork
     */
     ...
     * Sets scope_of_work
     *
     * @param \Webcom\Amazon\Rest\ServicesApi\Model\ScopeOfWork $scope_of_work The scope of work for the order.
     *
     * @return $this
     */
     ...
     * Gets seller
     *
     * @return \Webcom\Amazon\Rest\ServicesApi\Model\Seller
     */
     ...
     * Sets seller
     *
     * @param \Webcom\Amazon\Rest\ServicesApi\Model\Seller $seller Information about the seller of the service job.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\ServicesApi\Model\ServiceJobProvider
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\ServicesApi\Model\ServiceJobProvider $service_job_provider Information about the service job provider.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\ServicesApi\Model\AppointmentTime[]
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\ServicesApi\Model\AppointmentTime[] $preferred_appointment_times A list of appointment windows preferred by the buyer. Included only if the buyer selected appointment windows when creating the order.
     *
     * @return $this
     */
     ...
     * Gets appointments
     *
     * @return \Webcom\Amazon\Rest\ServicesApi\Model\Appointment[]
     */
     ...
     * Sets appointments
     *
     * @param \Webcom\Amazon\Rest\ServicesApi\Model\Appointment[] $appointments A list of appointments.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\ServicesApi\Model\OrderId
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\ServicesApi\Model\OrderId $service_order_id The Amazon-defined identifier for an order placed by the buyer, in 3-7-7 format.
     *
     * @return $this
     */
     ...
     * Gets buyer
     *
     * @return \Webcom\Amazon\Rest\ServicesApi\Model\Buyer
     */
     ...
     * Sets buyer
     *
     * @param \Webcom\Amazon\Rest\ServicesApi\Model\Buyer $buyer Information about the buyer.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\ServicesApi\Model\AssociatedItem[]
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\ServicesApi\Model\AssociatedItem[] $associated_items A list of items associated with the service job.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\ServicesApi\Model\ServiceLocation
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\ServicesApi\Model\ServiceLocation $service_location Information about the location of the service job.
     *
     * @return $this
     */
