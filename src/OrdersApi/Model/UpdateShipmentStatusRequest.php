...
class UpdateShipmentStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'shipmentStatus' => '\Webcom\Amazon\Rest\OrdersApi\Model\ShipmentStatus',
        'orderItems' => 'object[]'
    ];
     ...
     * Sets marketplaceId
     *
     * @param string $marketplaceId the unobfuscated marketplace ID
     *
     * @return self
     */
     ...
     * Gets shipmentStatus
     *
     * @return \Webcom\Amazon\Rest\OrdersApi\Model\ShipmentStatus
     */
     ...
     * Sets shipmentStatus
     *
     * @param \Webcom\Amazon\Rest\OrdersApi\Model\ShipmentStatus $shipmentStatus shipmentStatus
     *
     * @return self
     */
     ...
     * Sets orderItems
     *
     * @param object[]|null $orderItems the list of order items and quantities when the seller wants to partially update the shipment status of the order
     *
     * @return self
     */
