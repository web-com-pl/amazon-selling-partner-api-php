...
class OrderItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'product_info' => '\Webcom\Amazon\Rest\OrdersApi\Model\ProductInfoDetail',
        'points_granted' => '\Webcom\Amazon\Rest\OrdersApi\Model\PointsGrantedDetail',
        'item_price' => '\Webcom\Amazon\Rest\OrdersApi\Model\Money',
        'shipping_price' => '\Webcom\Amazon\Rest\OrdersApi\Model\Money',
        'item_tax' => '\Webcom\Amazon\Rest\OrdersApi\Model\Money',
        'shipping_tax' => '\Webcom\Amazon\Rest\OrdersApi\Model\Money',
        'shipping_discount' => '\Webcom\Amazon\Rest\OrdersApi\Model\Money',
        'shipping_discount_tax' => '\Webcom\Amazon\Rest\OrdersApi\Model\Money',
        'promotion_discount' => '\Webcom\Amazon\Rest\OrdersApi\Model\Money',
        'promotion_discount_tax' => '\Webcom\Amazon\Rest\OrdersApi\Model\Money',
        'promotion_ids' => '\Webcom\Amazon\Rest\OrdersApi\Model\PromotionIdList',
        'cod_fee' => '\Webcom\Amazon\Rest\OrdersApi\Model\Money',
        'cod_fee_discount' => '\Webcom\Amazon\Rest\OrdersApi\Model\Money',
        'is_gift' => 'bool',
        ...
        'tax_collection' => '\Webcom\Amazon\Rest\OrdersApi\Model\TaxCollection',
     ...
     * Gets product_info
     *
     * @return \Webcom\Amazon\Rest\OrdersApi\Model\ProductInfoDetail
     */
     ...
     * Sets product_info
     *
     * @param \Webcom\Amazon\Rest\OrdersApi\Model\ProductInfoDetail $product_info Product information for the item.
     *
     * @return $this
     */
     ...
     * Gets points_granted
     *
     * @return \Webcom\Amazon\Rest\OrdersApi\Model\PointsGrantedDetail
     */
     ...
     * Sets points_granted
     *
     * @param \Webcom\Amazon\Rest\OrdersApi\Model\PointsGrantedDetail $points_granted The number and value of Amazon Points granted with the purchase of an item.
     *
     * @return $this
     */
     ...
     * Gets item_price
     *
     * @return \Webcom\Amazon\Rest\OrdersApi\Model\Money
     */
     ...
     * Sets shipping_price
     *
     * @param \Webcom\Amazon\Rest\OrdersApi\Model\Money $shipping_price The shipping price of the item.
     *
     * @return $this
     */
     ...
     * Sets item_tax
     *
     * @param \Webcom\Amazon\Rest\OrdersApi\Model\Money $item_tax The tax on the item price.
     *
     * @return $this
     */
     ...
     * Sets shipping_tax
     *
     * @param \Webcom\Amazon\Rest\OrdersApi\Model\Money $shipping_tax The tax on the shipping price.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\OrdersApi\Model\Money $shipping_discount The discount on the shipping price.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\OrdersApi\Model\Money $shipping_discount_tax The tax on the discount on the shipping price.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\OrdersApi\Model\Money $promotion_discount The total of all promotional discounts in the offer.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\OrdersApi\Model\Money $promotion_discount_tax The tax on the total of all promotional discounts in the offer.
     *
     * @return $this
     */
     ...
     * Gets promotion_ids
     *
     * @return \Webcom\Amazon\Rest\OrdersApi\Model\PromotionIdList
     */
     ...
     * Sets promotion_ids
     *
     * @param \Webcom\Amazon\Rest\OrdersApi\Model\PromotionIdList $promotion_ids promotion_ids
     *
     * @return $this
     */
     ...
     * Sets cod_fee
     *
     * @param \Webcom\Amazon\Rest\OrdersApi\Model\Money $cod_fee The fee charged for COD service.
     *
     * @return $this
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\OrdersApi\Model\Money $cod_fee_discount The discount on the COD fee.
     *
     * @return $this
     */
     ...
     * Gets tax_collection
     *
     * @return \Webcom\Amazon\Rest\OrdersApi\Model\TaxCollection
     */
     ...
     * Sets tax_collection
     *
     * @param \Webcom\Amazon\Rest\OrdersApi\Model\TaxCollection $tax_collection Information about withheld taxes.
     *
     * @return $this
     */
