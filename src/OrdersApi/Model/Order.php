...
class Order implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'order_total' => '\Webcom\Amazon\Rest\OrdersApi\Model\Money',
        'number_of_items_shipped' => 'int',
        'number_of_items_unshipped' => 'int',
        'payment_execution_detail' => '\Webcom\Amazon\Rest\OrdersApi\Model\PaymentExecutionDetailItemList',
        'payment_method' => 'string',
        'payment_method_details' => '\Webcom\Amazon\Rest\OrdersApi\Model\PaymentMethodDetailItemList',
        ...
        'is_sold_by_ab' => 'bool',
        'assigned_ship_from_location_address' => '\Webcom\Amazon\Rest\OrdersApi\Model\Address',
        'fulfillment_instruction' => '\Webcom\Amazon\Rest\OrdersApi\Model\FulfillmentInstruction'
    ];
     ...
     * Sets order_total
     *
     * @param \Webcom\Amazon\Rest\OrdersApi\Model\Money $order_total The total charge for this order.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\OrdersApi\Model\PaymentExecutionDetailItemList
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\OrdersApi\Model\PaymentMethodDetailItemList
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\OrdersApi\Model\PaymentMethodDetailItemList $payment_method_details A list of payment methods for the order.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\OrdersApi\Model\Address
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\OrdersApi\Model\Address $assigned_ship_from_location_address The recommended location for the seller to ship the items from. It is calculated at checkout. The seller may or may not choose to ship from this location.
     *
     * @return $this
     */
     ...
     *
     * @return \Webcom\Amazon\Rest\OrdersApi\Model\FulfillmentInstruction
     */
     ...
     *
     * @param \Webcom\Amazon\Rest\OrdersApi\Model\FulfillmentInstruction $fulfillment_instruction Contains the instructions about the fulfillment like where should it be fulfilled from.
     *
     * @return $this
     */
