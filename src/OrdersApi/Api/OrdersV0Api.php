...
class OrdersV0Api
{
     ...
     * @throws \Webcom\Amazon\Rest\OrdersApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Webcom\Amazon\Rest\OrdersApi\Model\GetOrderRegulatedInfoResponse|\Webcom\Amazon\Rest\OrdersApi\Model\GetOrderRegulatedInfoResponse|\Webcom\Amazon\Rest\OrdersApi\Model\GetOrderRegulatedInfoResponse|\Webcom\Amazon\Rest\OrdersApi\Model\GetOrderRegulatedInfoResponse|\Webcom\Amazon\Rest\OrdersApi\Model\GetOrderRegulatedInfoResponse|\Webcom\Amazon\Rest\OrdersApi\Model\GetOrderRegulatedInfoResponse|\Webcom\Amazon\Rest\OrdersApi\Model\GetOrderRegulatedInfoResponse
     */
     ...
     * @throws \Webcom\Amazon\Rest\OrdersApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Webcom\Amazon\Rest\OrdersApi\Model\GetOrderRegulatedInfoResponse|\Webcom\Amazon\Rest\OrdersApi\Model\GetOrderRegulatedInfoResponse|\Webcom\Amazon\Rest\OrdersApi\Model\GetOrderRegulatedInfoResponse|\Webcom\Amazon\Rest\OrdersApi\Model\GetOrderRegulatedInfoResponse|\Webcom\Amazon\Rest\OrdersApi\Model\GetOrderRegulatedInfoResponse|\Webcom\Amazon\Rest\OrdersApi\Model\GetOrderRegulatedInfoResponse|\Webcom\Amazon\Rest\OrdersApi\Model\GetOrderRegulatedInfoResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderRegulatedInfoWithHttpInfo($orderId)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Webcom\Amazon\Rest\OrdersApi\Model\GetOrderRegulatedInfoResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Webcom\Amazon\Rest\OrdersApi\Model\GetOrderRegulatedInfoResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Webcom\Amazon\Rest\OrdersApi\Model\GetOrderRegulatedInfoResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
     ...
     *
     * @param  string $orderId An orderId is an Amazon-defined order identifier, in 3-7-7 format. (required)
     * @param  \Webcom\Amazon\Rest\OrdersApi\Model\UpdateVerificationStatusRequest $payload Request to update the verification status of an order containing regulated products. (required)
     *
     * @throws \Webcom\Amazon\Rest\OrdersApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Webcom\Amazon\Rest\OrdersApi\Model\UpdateVerificationStatusErrorResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
